...
def _start_background_jobs():
    ...
    from DB.dbCreation import ensure_payment_schema, ensure_payment_log_table, ensure_users_image_column, create_customer_reviews_table, ensure_product_master_email_columns, ensure_bundle_master_email_columns
    try:
        ensure_payment_schema()
        ensure_payment_log_table()
        ensure_users_image_column()
        ensure_product_master_email_columns()
        ensure_bundle_master_email_columns()
